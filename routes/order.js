        ...
        .then(async({role, parentId, departmentId, _id}) => {
            if (role || role === 0) {
                ...
                if (csv) {
                    ...
                    ws.write("客户姓名,顺丰运单号,货品名称,货品数量,订单状态,下单状态,寄件人公司名称,寄件人姓名,寄件人联系电话,寄件人详细地址,收件人公司名称,收件人姓名,收件人联系电话,收件人详细地址,是否代收货款,代收货款金额,代收货款卡号,下单时间,最近一次修改\r\n", () => {
                    });
                    for (let i of data) {
                        let mailno = i.mailno
                        if (!mailno) {
                        ...
                        ws.write(i.nickName + "," + mailno + "," + i.Cargo[0].name + "," + i.Cargo[0].count + "," + isReview + "," + isSub + "," + i.j_company + "," + i.j_contact + "," + i.j_tel + "," + i.j_address + "," + i.d_company + "," + i.d_contact + "," + i.d_tel + "," + i.d_address + "," + cod + "," + cod_count + "," + cod_card + "," + getDay(i.createAt) + "," + getDay(i.updateAt) + "\r\n", () => {
                        });
